...
const LandingPage = () => {
  ...
  const onClickFood = () => {
    ...
    $(".md_content > p").html(
      "re:cipe;<br/>다양한 푸드트럭에서 <br/>모두 함께 맛있는 음식을 즐겨보세요!<br/><br/><장소><br/>서울여자대학교 제1과학관 앞 도로 <br/><br/><라인업><br/>짱츄닭(수제닭꼬치)<br/>부부츄(츄러스,소떡소떡)<br/>에이치키친(회오리감자)<br/>스테이킹(스테이크)<br/>푸드진열장(수제타코야끼)<br/>스낵런(칠리, 크림새우)<br/>핫플(홍콩에그와플)<br/><br/>*가격은 푸드트럭 별로 상이합니다."
    );
    showModal();
  };
